export default {
  ...
  version: {
    ...
    redeployRequired: 'Host redeploy required',
    redeployQueued: 'The deployment request was recorded. Run this command on the Docker host.',
    redeployCommand: 'Docker host command',
